...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      'Проектиране, изграждане и поддръжка на надеждни пожароизвестителни системи за ранно откриване на пожари и осигуряване на безопасност.',
    bullets: [
      'Конвенционални и адресируеми системи',
      'Детектори за дим, топлина и въглероден оксид',
      'Оповестителни и евакуационни системи',
      'Профилактика и абонаментна поддръжка',
    ],
    icon: Flame,
  },
]
